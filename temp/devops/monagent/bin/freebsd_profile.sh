...
MON_AGENT_BACKUP_PLUGINS_ID_FILE=$MON_AGENT_BACKUP_CONF_DIR/$MON_AGENT_PLUGINS_ID_FILE_NAME
MON_AGENT_BACKUP_PLUGINS_LIST_FILE=$MON_AGENT_BACKUP_CONF_DIR/$MON_AGENT_PLUGINS_LIST_FILE_NAME
